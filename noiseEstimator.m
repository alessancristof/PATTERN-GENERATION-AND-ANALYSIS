...
% BinSize: number of element contained in each bin during binning operations over the blocks.
...
% validation purpose.
% ExtraFigureSliceNumber: show extra graphics for this slice if the processing is performed per slice;
...
if NEParameters.SeparateSlices
    ...
    for i=1:size(I,3)
        if and(i==NEParameters.ExtraFigureSliceNumber,flag_figure)
